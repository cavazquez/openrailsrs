...
pub use material::{
    ...
    finalize_scenery_material, legacy_standard_scenery_enabled, or_lighting_enabled,
    ...
    shape_alpha_mode, shape_shader_requests_blending, texture_name_suggests_transparency,
