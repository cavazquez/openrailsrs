...
pub use material::{
    ...
    OR_BLEND_PASS_TRANS_CUTOFF, SCENERY_TEXTURE_ALBEDO_BOOST, SCENERY_TEXTURE_TARGET_LUMA,
    ace_mean_luma, alpha_mode_from_prim_state, alpha_name_heuristic_enabled,
    apply_msts_vertex_tint, apply_standard_normal_map, apply_train_exterior_culling,
    ...
    cab_interior_albedo_boost, cab_or_scenery_material_with_texture,
    cab_or_scenery_material_with_texture_ex, finalize_scenery_material,
    legacy_standard_scenery_enabled, or_ace_requests_blending, or_lighting_enabled,
    resolve_or_lighting, scenery_albedo_tint, scenery_base_tint, scenery_material_tint_for_ace,
    scenery_materials_lit, scenery_uses_or_wgsl_shaders, shader_uses_vertex_color_multiply,
    shape_alpha_mode, shape_shader_requests_additive, shape_shader_requests_blend,
...
pub use mesh::{
    LoadedShape, LoadedShapePart, LodPolicy, MeshBuffers, MeshPartBuildOptions,
    MeshVertexColorMode, MeshVertexColorStats, append_primitive_mesh_buffers,
    append_primitive_mesh_buffers_ex, build_mesh_from_shape, build_mesh_from_shape_at_distance,
    build_mesh_from_shape_lod, build_mesh_parts_for_lod_band, build_mesh_parts_from_shape,
    build_mesh_parts_from_shape_at_distance, build_mesh_parts_from_shape_at_distance_with_options,
    build_mesh_parts_from_shape_lod, build_mesh_parts_from_shape_lod_with_options,
    closest_lod_level, closest_lod_levels, ensure_tangents_for_normal_mapping,
    light_mat_idx_for_prim_state, lod_band_count, lod_level_for_distance,
    lod_level_index_for_control, lod_level_index_for_distance,
    lod_level_index_for_distance_with_policy, lod_levels_for_distance, mesh_aabb,
