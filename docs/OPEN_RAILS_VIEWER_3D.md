...
**Cabina 3D (`CABVIEW3D`) — estado y próximos pasos:** [`CABVIEW3D_ROADMAP.md`](CABVIEW3D_ROADMAP.md).  
**Referencia OpenBVE (CVF, SMS, parsers tren):** [`OPENBVE_REFERENCE.md`](OPENBVE_REFERENCE.md).
